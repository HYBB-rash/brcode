...
public interface EditPaperService {
     ...
     * @param userId 用户的ID
     * @param paperId 文章的ID
     * @return 根据VueEditPaper结构打包
     */
    public VueEditPaper getPaperContent(Integer userId, Integer paperId);
     ...
     * @return 返回一个成功信息即可
     */
    public Boolean savePaper(VueEditPaper paper);
     ...
     * @return 返回一个成功信息即可
     */
    public Boolean savePaperAndSent(VueEditPaper paper);
}
